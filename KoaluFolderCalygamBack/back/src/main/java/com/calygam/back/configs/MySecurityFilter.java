...
public class MySecurityFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if(path.equals("/auth/register")|| path.equals("/auth/login") ||path.contains("/file/read/user/")||path.startsWith("/file/read")||path.contains("/file")|| path.equals("/auth/google") || path.equals("/auth/google/callback")) {
